...
def separate_distributions(data):
    # split data into two parts, sorted by the first variable
    random.shuffle(data)
...
def load_data(args):
    ...
    # solution is reversed? -> reverse data (cause is always the first variable)
...
def main(args):
    # load data (contains list per variable) (Cause is first)
