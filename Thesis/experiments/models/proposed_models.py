...
class Model1(Model, ConditionalModelA2B):
    ...
    def set_ground_truth(self, pi_A, pi_B_A):
        ...
        # Compute the log of the probabilities and assign it to the weights
...
class StructuralModel(BinaryStructuralModel):
    def __init__(self, N, dtype=None):
        ...
        # Weight for the causal direction (to optimize)
        self.w = nn.Parameter(torch.tensor(0., dtype=dtype))

    # The ground truth is the actual values or the source of truth
    # that the models are trying to learn and predict
    def set_ground_truth(self, pi_A, pi_B_A):
