...
def main(args):
    ...
    cg.draw_pydot_graph(labels=['Alt', 'Temp', 'Preci', 'Long', 'Sun'])
    ...
    for i in range(number_vars):
        for j in range(i):
            ...
            if left_right_value == 1 and right_left_value == -1:
                print(i, '<--', j)
                edge = pydot.Edge(map_index_to_value(j), map_index_to_value(i), dir="none")
                graph.add_edge(edge)
            elif left_right_value == -1 and right_left_value == 1:
                print(i, '-->', j)
                edge = pydot.Edge(map_index_to_value(i), map_index_to_value(j), dir="none")
                graph.add_edge(edge)
            elif left_right_value == 1 and right_left_value == 1:
                print(i, '<-->', j)
                edge = pydot.Edge(map_index_to_value(i), map_index_to_value(j), dir="none")
    ...
    graph.write_png('img_scriptie/exp3_pc_multi.png')
