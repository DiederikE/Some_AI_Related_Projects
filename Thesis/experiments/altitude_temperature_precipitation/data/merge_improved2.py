...
with open("pair0001.txt", "r") as file1, open("pair0002.txt", "r") as file2, open("pair0004.txt", "r") as file4:
...
for line1, line2, line4 in zip(lines1, lines2, lines4):
    ...
    merged_line = f"{data1[0]} {data1[1]} {data2[1]} {data4[1]}\n"
    merged_data.append(merged_line)

# Write the merged data to a new file
with open("alt_temp_prec_sun.txt", "w") as merged_file:
